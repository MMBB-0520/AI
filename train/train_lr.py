...
train_lr.py
-----------
Trains a tuned Logistic Regression (LR) classifier to recognize user intents 
...
VECTORIZER_PATH = os.path.join(MODEL_DIR, "lr_vectorizer.pkl")
ENCODER_PATH = os.path.join(MODEL_DIR, "lr_label_encoder.pkl")
CM_PATH = os.path.join(MODEL_DIR, "lr_confusion_matrix.png")

def main():
    print("=" * 60)
    print("Loading Bitext Hospitality Dataset & Training Optimized Logistic Regression")
    print("=" * 60)
    ...
    plt.title("Logistic Regression Intent Classification - Confusion Matrix", fontsize=16, pad=20, fontweight='bold')
